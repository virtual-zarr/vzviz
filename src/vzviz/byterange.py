...
def byte_range_chart_interactive(
    ...
    def render_with_selection(
        ...
        # Get selected chunk keys from selection state (includes both bounds and variable selection)
        selected_keys = selection_state.get_selected_chunk_keys(plot_df)
    ...
    # Create stream for selection state changes (watch both bounds and selected_variables)
